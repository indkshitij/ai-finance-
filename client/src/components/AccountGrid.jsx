    ...
    <>
      <section>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <CreateAccountDrawer>
            <Card className="w-full h-52 transition-all shadow-md duration-300 transform hover:scale-[1.02] hover:shadow-xl cursor-pointer flex justify-center items-center">
